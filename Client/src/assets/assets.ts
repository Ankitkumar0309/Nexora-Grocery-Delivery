...
export const appPromoBannerData = {
    ...
    description: "Download the Nexora app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
...
export const footerData = {
    ...
    contact: [
        { icon: MapPinIcon, text: "123 Green Valley Rd, Gujarat" },
        { icon: PhoneIcon, text: "+1 (011) 123-4567" },
...
export const dummyDashboardOrdersData = [
    ...
    {
        shippingAddress: { label: "Home", address: "New Market Road ", city: "Gujarat ", state: "NY", zip: "876543", lat: 40.7128, lng: -74.006 },
...
export const dummyAddressData = [
    { label: "Home", address: "123 Main St ", city: "Gujarat ", state: "NY", zip: "10001", isDefault: true, lat: 40.7128, lng: -74.006, _id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "456 Market St ", city: "Gujarat ", state: "NY", zip: "10002", isDefault: false, lat: 40.7128, lng: -74.006, _id: "69d3652df9a340288f1a0f8d" },
];
