        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
            ...
            <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                    <button className="px-6 py-3 bg-white text-green-950 font-semibold rounded-xl
                    hover:bg-orange-100">App Store</button>
            ...
            {/* Right Side image */}
            <img src={assets.delivery_truck} alt="Delivery Truck" className="max-w-60
