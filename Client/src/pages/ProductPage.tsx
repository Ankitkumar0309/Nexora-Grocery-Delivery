...
const ProductPage = () => {
  ...
  const handlePlus = ()=>{
    if(inCart)updateQuantity(product._id, cartItem.quantity + 1)
      else setLocalQuantity(loacalQuantity + 1)
  }
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
                ...
                <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                  {product.isOrganic && (
                    <span className="flex item-center gap-1 px-2.5 py-1 text-xs font-semibold bg-app-green text-white rounded-full">
              ...
              <div className="p-6 md:p-10 flex flex-col justify-center">
                ...
                <div className="flex items-baseline gap-3 mb-5">
                  ...
                  {product.originalPrice > product.price && (
                    ...
                    {currency}{product.originalPrice.toFixed(2)}</span>
                  )}
                </div>
          ...
          {relatedProducts.length > 0 && (
            <section className="mt-12 mb-44">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link className="text-sm font-semibold text-app-orange hover:text-app-orange-dark 
