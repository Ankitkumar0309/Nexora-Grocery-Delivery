...
const Addresses = () => {
  ...
  const [form, setFrom] = useState({ label : "",
                                     address: "",
                                     city: "",
                                     state: "",
                                     zip: "",
  ...
  const resetForm = ()=>{
    setFrom({label: "", address: "", city: "", state: "", zip: "", isDefault: false})
    setShowForm(false)
    setEditingId(null)
  }
    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button onClick={()=> {resetForm(); setShowForm(true)}} className="px-4 py-2 bg-app-green 
          text-white text-sm font-semibold rounded-2xl hover:bg-app-green-light transition-colors 
        ...
        form={form} setFrom={setFrom} editingId={editingId}/>}
