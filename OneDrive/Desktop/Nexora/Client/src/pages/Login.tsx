  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
          ...
          <img src={heroSectionData.hero_image} alt="" className="absolute inset-0 object-cover h-full 
          bg-center opacity-10"/>
          <div className="relative text-center px-12">
            <h2 className="text-4xl font-semibold text-white mb-4">Welcome back to Nexora</h2>
        ...
        <div className="flex-1 flex-center px-4 py-12 bg-app-cream">
          <div className="w-full max-w-md">
            {/* from header messaage */}
            <div className="text-center mb-8">
              <Link to="/" className="inline-flex item-center gap-2 mb-6">
                  <BikeIcon className="size-8 text-app-green" />
                  <span className="text-2xl font-semibold text-app-green">Nexora</span>
              </Link>
              ...
              <p className="text-sm text-app-text-light">
                ...
                <button onClick={()=>setIsLoginState(!isLoginState)} className="text-orange-500 ml-1 
             ...
             <form onSubmit={handleSubmit} className="space-y-5">
                ...
                transition-color disabled:opacity-50">
                  {loading ? <Loader2Icon className="animate-apin"/> :
