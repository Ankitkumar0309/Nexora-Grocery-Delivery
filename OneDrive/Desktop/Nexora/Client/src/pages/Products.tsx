    ...
    <div className="min-h-screen bg-app-cream">
        ...
        <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white rounded-2xl p-4 sticky top-24">
              ...
              <FilterPanel categories={categoriesData} category={category} or organic={organic}
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                className="lg:hidden flex items-center gap-2 px-3 py-2 text-sm bg-white rounded-xl 
                border border-app-border hover:bg-app-cream transition-colors">
            ...
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt-16">
                {Array.from({length: totalPages}).map((_, i)=>(
                  ...
                  className={`size-9 rounded-lg text-sm text-sm font-medium transition-colors ${page ===
                  i + 1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
                  </button>
                ))}
      ...
      {mobileFiltersOpen && (
        ...
        <div className="fixed inset-0 bg-black/40 z-50" onClick={()=>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh]
